...
public class GUI extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		 ...
		 */
		Solver p1 = new AI(Board.Player.RED, 5, AI.Algorithm.ALPHABETA, AI.Evaluation.UTILITY);
//		Solver p1 = new AI(Board.Player.RED, 6, AI.Algorithm.ALPHABETA, AI.Evaluation.CONNECTIVITY);
		Solver p2 = new AI(Board.Player.YELLOW, 5, AI.Algorithm.MINIMAX, AI.Evaluation.UTILITY);
//		Solver p2 = new AI(Board.Player.YELLOW, 4, AI.Algorithm.ALPHABETA, AI.Evaluation.CONNECTIVITY);
